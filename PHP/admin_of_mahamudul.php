<html>
	<title>Admin of Dr. Mahamudul</title>
	<style>
		form{
	...
	<form action="submit_after_appointment_with_mahamudul.php" method="post">
		<h2>Admin Of Dr. Mahamudul Hasan</h2>
...
$result = mysql_query("select * from tblmahamudul", $conn);

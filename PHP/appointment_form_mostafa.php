...
<html lang="en">
	<div class="maindiv">
		<head>
			<title>Appointment with Dr.Mostafa</title>
			<meta charset="UTF-8" />
...
<div class="noticemarquee">
	<marquee dir="ltr" scrollamount="2" scrolldelay="10" >Now Dr. Mostafa is in his chamber and is meeting with patients </marquee>
</div>
			<div class="formdiv">
				<h1 align="center"> Sign up Here </h1>
				
				<form action="appointment_with_mostafa.php" method="post">
			...
			<div class="physicianinfo">
				<h2>Dr.Mostafa Miah</h2>
				<img src="../physician_image/mostafa.jpg" id="imagesize" />
				<p>
					<pre>
	...
	Mobile No.:01938782837
			...
			<h3>Today's Patients List <a href="print_allpatienlist_of_mostafa.php">(To see All patients click here)</a></h3>
			<?php
			require 'print_todaypatienlist_of_mostafa.php';
			?>
